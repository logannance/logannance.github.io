...
function numeralChange(this: HTMLInputElement, ev: Event): void {
...
function setEnglish(engl: string): void {
...
function makeValidNumeral(s: string): string | null {
...
function negativePortion(numeral: string): string {
    return numeral[0] === '-' ? 'negative ' : '';
}

function integerPortion(numeral: string): string | null {
...
function convertRemainder(remainder: string): string {
...
function removeExtraLeadingZeros(integers: string): string {
